  ...
  <div class="innerArea">
    <div class="inner clearfix">
      ...
      <div id="language" class="clearfix">
        <span class="tit pull-left">语言</span>
        <ul class="pull-left">
          <li>
            <a href="http://en.huluanpao.com" class="active">English<span class="glyphicon glyphicon-menu-down" aria-hidden="true"></span></a>
      ...
      <div id="shareBar" class="clearfix">
        <div class="tit pull-left">Follow Us</div>
